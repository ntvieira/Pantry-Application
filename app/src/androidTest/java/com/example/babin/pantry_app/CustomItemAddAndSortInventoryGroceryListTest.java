...
public class CustomItemAddAndSortInventoryGroceryListTest {

    @Rule
    public ActivityTestRule<LoginPage> mActivityTestRule = new ActivityTestRule<>(LoginPage.class);

    @Test
    public void customItemAddAndSortInventoryGroceryListTest() {
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.text_input),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("apple"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.text_input),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("burrito"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.quantity_input),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("14"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.text_input),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText9.perform(replaceText("carrot"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText12 = onView(
                allOf(withId(R.id.editText),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText12.perform(replaceText("apple"), closeSoftKeyboard());

        ViewInteraction appCompatEditText13 = onView(
                allOf(withId(R.id.editTextQ),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        0),
        ...
        ViewInteraction appCompatButton14 = onView(
                allOf(withId(R.id.manuallyEnterItem),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        0),
        ...
        ViewInteraction appCompatEditText15 = onView(
                allOf(withId(R.id.editText),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText15.perform(replaceText("donuts"), closeSoftKeyboard());
